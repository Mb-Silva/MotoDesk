...
public class Clientes extends JFrame {
	...
	public Clientes() {
		...
		panel.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "Clientes", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		JLabel lblNewLabel_2_1_2 = new JLabel("(11) 99999-9999");
		...
		JLabel lblNewLabel_2_1_2_1 = new JLabel("(11) 99999-9999");
		lblNewLabel_2_1_2_1.setBounds(403, 43, 87, 14);
		panel_1.add(lblNewLabel_2_1_2_1);
		
		JLabel lblNewLabel_2_1_2_1_1 = new JLabel("000.000.000-00");
		lblNewLabel_2_1_2_1_1.setBounds(306, 43, 87, 14);
		panel_1.add(lblNewLabel_2_1_2_1_1);
		
		JLabel lblNewLabel_2_1_2_1_1_1 = new JLabel("000.000.000-00");
		lblNewLabel_2_1_2_1_1_1.setBounds(307, 78, 87, 14);
		panel_1.add(lblNewLabel_2_1_2_1_1_1);
		
		JLabel lblNewLabel_3_2 = new JLabel("*********");
		lblNewLabel_3_2.setBounds(214, 43, 78, 14);
		panel_1.add(lblNewLabel_3_2);
		
		JLabel lblNewLabel_3_2_1 = new JLabel("*********");
		lblNewLabel_3_2_1.setBounds(215, 80, 78, 14);
